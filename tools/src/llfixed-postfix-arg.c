...
static int llfixed_stack__operation_do(const int operation_symbol) { 
  ...
  case OPERATION_SYMBOL__ADD: { assert(2 <= llfixed_stack_nb); const long long int a = llfixed_stack[llfixed_stack_nb - 2]; const long long int b = llfixed_stack[llfixed_stack_nb - 1]; llfixed_stack[llfixed_stack_nb - 2] = a + b; llfixed_stack_nb--; break; }; 
  case OPERATION_SYMBOL__SUB: { assert(2 <= llfixed_stack_nb); const long long int a = llfixed_stack[llfixed_stack_nb - 2]; const long long int b = llfixed_stack[llfixed_stack_nb - 1]; llfixed_stack[llfixed_stack_nb - 2] = a - b; llfixed_stack_nb--; break; }; 
  case OPERATION_SYMBOL__MULT: { assert(2 <= llfixed_stack_nb); const long long int a = llfixed_stack[llfixed_stack_nb - 2]; const long long int b = llfixed_stack[llfixed_stack_nb - 1]; llfixed_stack[llfixed_stack_nb - 2] = llfixed__mult(a, b); llfixed_stack_nb--; break; }; 
  case OPERATION_SYMBOL__DIV: { assert(2 <= llfixed_stack_nb); const long long int a = llfixed_stack[llfixed_stack_nb - 2]; const long long int b = llfixed_stack[llfixed_stack_nb - 1]; llfixed_stack[llfixed_stack_nb - 2] = llfixed__div(a, b); llfixed_stack_nb--; break; }; 
/*
...
int main(const int argc, const char * argv[]) { 
  ...
  label__body: { 
    ...
    for (int16_t llfixed_stack_i = 0; llfixed_stack_i < llfixed_stack_nb; llfixed_stack_i++) { 
